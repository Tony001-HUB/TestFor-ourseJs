...
const personalMovieDB = {
    ...
    writeYourGenres(numberOfRepetitionsQuestion){
...
//(nameFilm === "") ? writeYourGenres() : console.log(`Спасибо за ответ`); пустой
//(nameFilm === null) ? writeYourGenres() : console.log(`Спасибо за ответ`); отмена
